...
//	private String mLastUpdateTime;
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
			...
			mFooterTextView
					.setText(R.string.xlistview_footer_hint_normal);
	 ...
	 *            Last updated at.
	 */
	public void onHeaderRefreshComplete(Long lastTime) {
	 ...
	 *            Last updated at.
	 */
	public void setLastUpdated(Long lastTime) {
		if (lastTime != 0) {
			mHeaderUpdateTextView.setVisibility(View.VISIBLE);
			mHeaderUpdateTextView.setText("上次更新时间：" + FriendDateFormat.friendlyTime(lastTime));
		} else {
