...
public class OrderTabsPagerAdapter extends FragmentPagerAdapter {
    
    private final String TAG = "TabsPagerAdapter";
    // private Map<Integer, Fragment> ref = new HashMap<Integer, Fragment>();
    private String[] tabs = { "全部", "待支付", "待评价"};
    private String[] flags = { "1", "2", "3"};
    
    public OrderTabsPagerAdapter(FragmentActivity fragmentActivity, FragmentManager fm) {
        super(fm);
    }
