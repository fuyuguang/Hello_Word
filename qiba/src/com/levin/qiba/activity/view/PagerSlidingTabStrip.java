...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft, height - 8, lineRight, height, rectPaint);
        // RectF rf = new RectF(lineLeft, height-8, lineRight, height);
        // canvas.drawRoundRect(rf, 30.0f, 30.0f, rectPaint);
        // draw underline
